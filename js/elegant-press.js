...
(function ($) {
    ...
    $.fn.prettyPhoto = function (pp_settings) {
        ...
        $.prettyPhoto.initialize = function () {
            ...
            if (settings.theme == 'dark_rounded') settings.horizontal_padding = 16;
            if (settings.ie6_fallback && $.browser.msie && parseInt($.browser.version) == 6) settings.theme = "dark_rounded";
        ...
        $.prettyPhoto.open = function (event) {
            if (typeof settings == "undefined") {
                settings = pp_settings;
                if ($.browser.msie && $.browser.version == 6) settings.theme = "dark_rounded";
